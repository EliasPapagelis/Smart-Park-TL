...
class ReservationFormScreen(BoxLayout):
    def __init__(self, screen_manager, **kwargs):
        ...
        available_hours = [f"{h:02d}:00" for h in range(8, 21)]
        self.add_widget(Label(text="Ώρα Έναρξης:"))
        ...
        self.add_widget(Label(text="Ώρα Λήξης:"))
        ...
        self.add_widget(self.end_time_spinner)
    ...
    def check_availability(self, instance):
        ...
        date_from = self.start_time_spinner.text
        date_to= self.end_time_spinner.text
